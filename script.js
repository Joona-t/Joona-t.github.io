...
// ══════════════════════════════════════════════════════════════════════════════
// GALLERY LIGHTBOX — click a "Sneak Peeks" screenshot to view it full-size
// ══════════════════════════════════════════════════════════════════════════════
(() => {
  const shots = document.querySelectorAll('.gallery-shot-btn');
  ...
  document.addEventListener('keydown', e => {
    ...
    if (e.key === 'Tab') { e.preventDefault(); closeBtn.focus(); } // trap focus on the only control
  });
})();
